...
const arrayReduceTransf = (nums, fn, init) => {
  ...
  // Expected Output: 10
  console.log(arrayReduceTransf([1,2,3,4],(function sum(accum, curr) { return accum + curr; }), 0));
  
  // Expected Output: 130
  console.log(arrayReduceTransf([1,2,3,4],(function sum(accum, curr) { return accum + curr * curr; }), 100));
  
  // Expected Output: 25
  console.log(arrayReduceTransf([],(function sum(accum, curr) { return 0; }), 25));
